...
router.patch('/:id', middlewareAuth.authenticate, middlewareAuth.requireAdmin, controllerUser.updateRole);
router.delete('/:id', middlewareAuth.authenticate, middlewareAuth.requireAdmin, controllerUser.remove);
